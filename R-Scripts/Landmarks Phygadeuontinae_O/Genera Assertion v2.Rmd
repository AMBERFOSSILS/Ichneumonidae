...
landmark <- Abind(landmarkphygad,meanfossil,meanisa, landmarkModern[,,subfamMod %in% "phygad"])
...
my_colors1[i] <- switch(substr(Label[i],1,6), "phygad" = "lightpink", "meansp" = "maroon1", "meanis" = "mediumorchid1")
}
...
legend("topright", legend=levels(subfam), col= c("mediumorchid1","maroon1", "lightpink"), pch=15, cex = 2)
