...
landmark <- Abind(landmarkphygad,meanfossil,landmarkisa, landmarkModern[,,subfamMod %in% "phygad"])
...
legend("topright", legend=levels(subfam), col= c("marron1", "lightpink"), pch=15, cex = 2)
