...
For the creation of the Dendrogramm only the first 17 PC scores were considered, which contribute to about 95.3% of variation. The fossil clusters with the Gelinae with one Ichneumininae adjoining. The fossil seems to belong to the subfamily Gelinae. The subfamilies cluster in groups with some outliers that are present in other subfamilies. 
