...
## PCA Analysis
A PCA was done with the subfamilies Pimplinae, Gelinae, Ophioninae, Ichenumoninae and Banichnae.The ophioninae are seperated from the rest of the subfamilies quite strongly.The pimplinae are also partially seperated. They partly overlap with Gelinae and Ichneumoninae. The Gelinae overlap mostly with Banchinae and partially with Pimplinae. Overall the subfamilies cluster mostly in groups. However, there are some outliers clustering within another group.   
