...
Fossil <- readland.tps("FOSSIL.TPS",specID = "ID", readcurves = T, warnmsg = TRUE)
Phygadeuontinae <- readland.tps("DATA_MODERN_TAX.tps",specID = "ID", readcurves = T, warnmsg = TRUE)
Banchinae <- readland.tps("banchinae.tps",specID = "ID", readcurves = T, warnmsg = TRUE)
Ophioninae <- readland.tps("ophioninae.tps",specID = "ID", readcurves = T, warnmsg = TRUE)
Pimplinae <- readland.tps("pimplinae.tps",specID = "ID", readcurves = T, warnmsg = TRUE)
landmark = Abind(Phygadeuontinae, Banchinae, Ophioninae, Pimplinae, Fossil)
...
plot3d(cva$CVscores[,1:3], col = colors, size = 9, 
      xlab=paste("1st canonical axis", paste(round(cva$Var[1,2],1),"%")),
     ylab=paste("2nd canonical axis", paste(round(cva$Var[2,2],1),"%")),
      zlab=paste("3rd canonical axis", paste(round(cva$Var[3,2],1),"%")),)
legend3d("topright", legend = c("Banchinae","Fossil" ,"Ophioninae", "Phygadeuontinae", "Pimplinae"), col = c("red","cyan","magenta","yellow") , pch= 16)
...
``` {r 3D1 , webgl = TRUE}
plot3d(cva$CVscores[,c(1,2,4)], col = colors, size = 9,
       xlab=paste("1st canonical axis", paste(round(cva$Var[1,2],1),"%")),
     ylab=paste("2nd canonical axis", paste(round(cva$Var[2,2],1),"%")),
      zlab=paste("4th canonical axis", paste(round(cva$Var[4,2],1),"%")),)
legend3d("topright", legend = c("Banchinae","Fossil" ,"Ophioninae", "Phygadeuontinae", "Pimplinae"), col = c("red","cyan","magenta","yellow") , pch= 16)
```
