...
my_colors[i] <- switch(substr(row.names(PCA$pc.scores[,])[i],8,13), "banchi" = "gold1", "ichneu" = "lightskyblue", "ophion" = "blueviolet",  "phygad" = "lightpink","pimpli" = "chartreuse3")
}

par(mar=c(4, 4, 1, 1)) # sets the margins
plot(PCA$pc.scores[,1],PCA$pc.scores[,2], col=my_colors, asp=T, las=1,pch=16, cex=1.5)
legend("topright", legend= levels(subfam1), col= c("gold1", "lightskyblue", "blueviolet", "lightpink", "chartreuse3"), pch=rep(19,14) )
