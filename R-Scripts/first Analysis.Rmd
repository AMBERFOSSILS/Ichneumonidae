...
#TODO: change Imagenames, so that subfam works (problem: Genus + sp is species Name)
...
```{r 3D, rgl = TRUE}
plot3d(PCA$pc.scores[,c(1,2,3)], col = palette(), size = 10)
text3d(PCA$pc.scores[,1:3],texts=species,pos=4,cex= 1)
legend3d(0.1, 0.2, legend = c("Echthrini","Mesostenini", "Gelini", "Fossil"), col = c("red", "blue", "green", "yellow"), pch= 16)
```